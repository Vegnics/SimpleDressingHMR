...
mv -f yolov8l-pose.pt ./ultraytics/.
...
unzip -o ./SMPL_estimator/trained_models/total_capture_model_paired.zip -d ./SMPL_estimator/trained_models/.
...
unzip -o ./SMPL_estimator/trained_models/total_capture_model.zip -d ./SMPL_estimator/trained_models/.
...
unzip -o ./SMPL_estimator/trained_models/base_model.zip -d ./SMPL_estimator/trained_models/.
