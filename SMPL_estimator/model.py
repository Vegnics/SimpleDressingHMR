...
from SMPL_estimator.model_util import batch_align_by_pelvis, batch_compute_similarity_transform, batch_rodrigues
...
class HMRModel:
    ...
    def _build_model(self):
        ...
        print("Checkpoint: ",self.config.RESTORE_PATH)
